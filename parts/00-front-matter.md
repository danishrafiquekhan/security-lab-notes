**Security Operations Lab — Complete Reference**<!--h1-->

**From First Setup to Advanced Identity Security Practice**<!--h2-->

**How to use this document**<!--h3-->
...
It is organized in the order you would actually build the lab: first the build itself, then the identity security and detection engineering theory that gives the practical work its meaning, then incident response, automation, and cloud security material, then fully reproducible practical labs, a real troubleshooting log from actually building this, a glossary, and a paid-vs-free summary table.
...
**The philosophy behind this document**<!--h3-->
...
Paid products are marked clearly wherever they appear, and the free-tier limits that actually matter are spelled out — the aim throughout was to build something close to zero-cost, and where a paid product was still worth discussing (because it's what real employers actually run), that's noted honestly rather than glossed over.

**A note on how this lab differs from a training course lab**<!--h3-->
...
**Document structure at a glance**<!--h3-->
